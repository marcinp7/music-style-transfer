...
The data flow of the whole architecture is comprised of 3 stages: style extraction, predicting song information, and style application.
...
It's worth noting that because of that, those fractions are not equidistant, meaning that it's not justified to apply convolution along the \emph{note fraction} dimension.
